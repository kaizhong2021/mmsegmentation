...
@MODELS.register_module()
def FasterNetT0():
    model = partial(FasterNet, inner_channels=[40, 80, 160, 320], blocks=[1, 2, 8, 2], act='GELU', drop_path=0.)
    return model

@MODELS.register_module()
def FasterNetT1():
    model = partial(FasterNet, inner_channels=[64, 128, 256, 512], blocks=[1, 2, 8, 2], act='GELU', drop_path=0.02)
    return model

@MODELS.register_module()
def FasterNetT2():
    model = partial(FasterNet, inner_channels=[96, 192, 384, 768], blocks=[1, 2, 8, 2], act='ReLU', drop_path=0.05)
    return model

@MODELS.register_module()
def FasterNetS():
    model = partial(FasterNet, inner_channels=[128, 256, 512, 1024], blocks=[1, 2, 13, 2], act='ReLU', drop_path=0.1)
    return model

@MODELS.register_module()
def FasterNetM():
    model = partial(FasterNet, inner_channels=[144, 288, 576, 1152], blocks=[3, 4, 18, 3], act='ReLU', drop_path=0.2)
    return model

@MODELS.register_module()
def FasterNetL():
    model = partial(FasterNet, inner_channels=[192, 384, 768, 1536], blocks=[3, 4, 18, 3], act='ReLU', drop_path=0.3)
    return model
